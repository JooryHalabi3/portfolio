  ...
  isActive
    ...
    : "text-text-secondary hover:text-gold-light"
              ...
              >
               ...
               <span
  aria-hidden="true"
  className={`absolute bottom-0 left-1/2 h-px -translate-x-1/2 bg-gold transition-opacity duration-300 ${
    isActive
      ? "w-8 opacity-100"
      : "w-8 opacity-0"
  }`}
/>
        ...
        <div className="hidden shrink-0 items-center gap-2 lg:flex">
          ...
          <Link
            ...
            className="group inline-flex h-10 items-center gap-2 rounded-full px-3.5 text-sm font-medium text-text-secondary transition-colors hover:bg-white/[0.04] hover:text-gold-light"
          >
          ...
          <Link
            ...
            className="group inline-flex h-10 items-center gap-2 rounded-full border border-gold/55 px-4 text-sm font-medium text-gold-light transition-all duration-300 hover:border-gold hover:bg-gold hover:text-background"
          >
            <span>
          ...
          >
            ...
            <div className="mt-5 flex gap-3">
              <Link
                ...
                className="inline-flex h-11 flex-1 items-center justify-center gap-2 rounded-full border border-brand-border text-sm font-medium text-text-secondary transition-colors hover:border-gold/50 hover:text-gold-light"
              >
                <Languages className="h-4 w-4 text-gold" />
              ...
              <Link
                ...
                rel="noopener noreferrer"
                onClick={closeMobileMenu}
                className="inline-flex h-11 flex-1 items-center justify-center gap-2 rounded-full border border-gold/60 text-sm font-medium text-gold-light transition-colors hover:bg-gold hover:text-background"
              >
                {dictionary.actions.downloadCV}
