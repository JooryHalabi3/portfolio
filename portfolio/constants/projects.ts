    ...
    gallery: [
      {
        ...
        description:
          "Displays hospital policies to patients and employees based on their roles.",
      ...
      },
      {
        ...
        caption: "User login",
        description: "User login interface for accessing the hospital information system.",
        orientation: "landscape",
      },
      {
        ...
        description: "Interface for patients and employees to create accounts.",
        orientation: "landscape",
      },
      {
        ...
        description: "Interface for managing patient profiles.",
        orientation: "landscape",
      },
      {
        ...
        description: "Interface for managing employee profiles.",
        orientation: "landscape",
      },
      {
        ...
        description: "Interface for viewing and managing hospital policies.",
        orientation: "landscape",
      },
      {
        ...
        description: "Interface for viewing role-based hospital services.",
        orientation: "landscape",
      },
      {
        ...
        description: "Dashboard for hospital administrators to manage the system.",
        orientation: "landscape",
      },
      {
        ...
        description: "Interface for managing administrator profiles.",
        orientation: "landscape",
      },
      {
        ...
        description: "Interface for managing contact messages and communications.",
        orientation: "landscape",
      },
      {
        ...
        description: "Interface for contacting hospital staff and managing communications.",
        orientation: "landscape",
      },
      {
        ...
        description: "Interface for evaluating hospital staff.",
        orientation: "landscape",
      },
      {
